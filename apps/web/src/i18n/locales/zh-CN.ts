...
export const zhCN: Dict = {
  ...
  'chat.example1Title': '融资路演 PPT',
  'chat.example1Tag': 'PPT',
  'chat.example1Prompt': '为一家正在融种子轮的设计工作室制作 10 页投资人路演 PPT。包含封面、问题、洞察、产品、市场、增长数据、商业模式、团队、融资诉求和联系方式。要有编辑感，但叙事清晰、图表克制，适合真实路演。',
  'chat.example2Title': '笔记 App 落地页',
  'chat.example2Tag': '落地页',
  'chat.example2Prompt': '为一款 AI 笔记 App 设计落地页，核心能力是记录会议、搜索重点、把笔记转成待办。包含首屏、产品预览、功能叙事、用户证明、价格、FAQ 和行动按钮。整体是安静高效的生产力工具气质，转化路径清楚。',
  'chat.example3Title': '冥想 App 移动原型',
  'chat.example3Tag': '移动',
  'chat.example3Prompt': '为一款冥想 App 制作四个移动端原型页面：首页、冥想播放页、进度与连续打卡、睡眠内容合集。补上首次使用引导、底部导航、可访问控制和轻柔动效说明，让流程能直接用于用户测试。',
