...
export const ar: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 جمع تمويل / مواد للمستثمرين',
  'settings.onboardingUseSales': '🤝 عرض مبيعات / عرض للعميل',
  'settings.onboardingUseConsulting': '📑 تسليم استشاري',
  ...
  'homeHero.title': 'ما العمل عالي القيمة الذي تريد تسليمه؟',
  'homeHero.startWithTemplate': 'اختر نوع التسليم أولاً',
  ...
  'homeHero.subtitlePrefix': 'اختر قالب استخدام مدفوعاً، ثم حسّنه بملفاتك وعلامتك وagent الخاص بك.',
  'homeHero.placeholder': 'صف تسليم الأعمال الذي تحتاجه…',
  'homeHero.placeholderActive': 'عدّل هذا brief للاستخدام المدفوع أو اكتب brief خاصاً بك…',
  ...
  'onboarding.buildTitle': 'اجعل كل تسليم مدفوع يبدو مقصوداً',
  'onboarding.buildBody': 'أسرع طريق لمخرجات أفضل هو البدء بنظام تصميم قابل لإعادة الاستخدام، ثم ترث عروض المستثمرين ونماذج SaaS ولوحات البيانات والتقارير وصفحات الهبوط الذوق نفسه.',
  'onboarding.buildBenefitMemoryTitle': 'طبقة ذوق قابلة لإعادة الاستخدام',
  'onboarding.buildBenefitMemoryBody': 'الألوان، الخطوط، المسافات، المكونات، الصوت والمراجع تصبح قواعد يستطيع agents استخدامها مجدداً.',
  'onboarding.buildBenefitAlignedTitle': 'يبقى العمل المدفوع متسقاً',
  'onboarding.buildBenefitAlignedBody': 'عروض pitch، مقترحات المبيعات، شاشات CRM، لوحات البيانات، PDFs وصفحات التسويق تستخدم المعيار نفسه.',
  'onboarding.buildBenefitSourcesTitle': 'ابدأ من دليل موجود',
  'onboarding.buildBenefitSourcesBody': 'استخدم موقعاً، repo، DESIGN.md، لقطات شاشة، خطوطاً، Figma أو artifact سبق تسليمه لعميل.',
  'onboarding.buildPreviewLabel': 'نظام جاهز للأعمال المدفوعة',
  'onboarding.buildStart': 'ابنِ نظام التصميم أولاً',
  'onboarding.buildHome': 'استكشف قوالب الاستخدام المدفوع',
