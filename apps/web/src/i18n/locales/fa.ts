...
export const fa: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 جذب سرمایه / متریال سرمایه‌گذار',
  'settings.onboardingUseSales': '🤝 پیشنهاد فروش / پیچ مشتری',
  'settings.onboardingUseConsulting': '📑 خروجی مشاوره',
  ...
  'homeHero.title': 'چه خروجی ارزشمندی باید تحویل دهید؟',
  'homeHero.startWithTemplate': 'اول نوع خروجی را انتخاب کنید',
  ...
  'homeHero.subtitlePrefix': 'یک قالب استفاده پولی انتخاب کنید و سپس با فایل‌ها، برند و agent خود آن را دقیق‌تر کنید.',
  'homeHero.placeholder': 'خروجی کسب‌وکاری مورد نیازتان را توصیف کنید…',
  'homeHero.placeholderActive': 'این brief استفاده پولی را ویرایش کنید یا brief خودتان را بنویسید…',
  ...
  'onboarding.buildTitle': 'هر خروجی پولی را هدفمند و حرفه‌ای نشان دهید',
  'onboarding.buildBody': 'سریع‌ترین مسیر به output بهتر، اول ساختن یک design system قابل استفاده مجدد است؛ سپس investor deck، prototypeهای SaaS، dashboardها، گزارش‌ها و landing pageها همان سلیقه را به ارث می‌برند.',
  'onboarding.buildBenefitMemoryTitle': 'لایه سلیقه قابل استفاده مجدد',
  'onboarding.buildBenefitMemoryBody': 'رنگ‌ها، تایپوگرافی، spacing، componentها، voice و referenceها به قوانین قابل استفاده مجدد برای agentها تبدیل می‌شوند.',
  'onboarding.buildBenefitAlignedTitle': 'کار پولی یکپارچه می‌ماند',
  'onboarding.buildBenefitAlignedBody': 'Pitch deck، sales proposal، CRM screens، dashboards، PDFs و marketing pages از یک استاندارد پیروی می‌کنند.',
  'onboarding.buildBenefitSourcesTitle': 'از شواهد موجود شروع کنید',
  'onboarding.buildBenefitSourcesBody': 'از website، repo، DESIGN.md، screenshots، fonts، Figma یا artifact قبلاً تحویل‌شده به مشتری استفاده کنید.',
  'onboarding.buildPreviewLabel': 'سیستم آماده کار پولی',
  'onboarding.buildStart': 'اول design system را بسازید',
  'onboarding.buildHome': 'قالب‌های استفاده پولی را ببینید',
