...
export const ru: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 Фандрайзинг / материалы для инвесторов',
  'settings.onboardingUseSales': '🤝 Коммерческое предложение / клиентский pitch',
  'settings.onboardingUseConsulting': '📑 Консалтинговый deliverable',
  ...
  'homeHero.title': 'Какой ценный бизнес-материал нужно подготовить?',
  'homeHero.startWithTemplate': 'Сначала выберите deliverable',
  ...
  'homeHero.subtitlePrefix': 'Выберите шаблон платного сценария, затем доработайте его файлами, брендом и agent.',
  'homeHero.placeholder': 'Опишите нужный бизнес-deliverable…',
  'homeHero.placeholderActive': 'Отредактируйте этот brief платного сценария или напишите свой…',
  ...
  'onboarding.buildTitle': 'Сделайте каждый платный deliverable продуманным',
  'onboarding.buildBody': 'Самый быстрый путь к лучшим output-ам — сначала переиспользуемая дизайн-система. Затем investor decks, SaaS-прототипы, dashboards, reports и landing pages наследуют один и тот же вкус.',
  'onboarding.buildBenefitMemoryTitle': 'Переиспользуемый слой вкуса',
  'onboarding.buildBenefitMemoryBody': 'Цвета, типографика, spacing, компоненты, voice и references становятся правилами, которые agents могут использовать снова.',
  'onboarding.buildBenefitAlignedTitle': 'Платная работа остается консистентной',
  'onboarding.buildBenefitAlignedBody': 'Pitch decks, sales proposals, CRM screens, dashboards, PDFs и marketing pages используют один стандарт.',
  'onboarding.buildBenefitSourcesTitle': 'Начните с уже существующих доказательств',
  'onboarding.buildBenefitSourcesBody': 'Используйте website, repo, DESIGN.md, screenshots, fonts, Figma или уже доставленный клиентский artifact.',
  'onboarding.buildPreviewLabel': 'Система для платных задач',
  'onboarding.buildStart': 'Сначала построить дизайн-систему',
  'onboarding.buildHome': 'Посмотреть шаблоны платных сценариев',
