...
export const it: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 Raccolta fondi / materiali per investitori',
  'settings.onboardingUseSales': '🤝 Proposta commerciale / pitch cliente',
  'settings.onboardingUseConsulting': '📑 Deliverable di consulenza',
  ...
  'homeHero.title': 'Quale deliverable di alto valore devi consegnare?',
  'homeHero.startWithTemplate': 'Scegli prima il deliverable',
  ...
  'homeHero.subtitlePrefix': 'Scegli un template per uso a pagamento, poi rifiniscilo con file, brand e agent.',
  'homeHero.placeholder': 'Descrivi il deliverable di business che ti serve…',
  'homeHero.placeholderActive': 'Modifica questo brief per uso a pagamento o scrivi il tuo…',
  ...
  'onboarding.buildTitle': 'Fai sembrare intenzionale ogni deliverable pagato',
  'onboarding.buildBody': 'Il modo più veloce per migliorare gli output è prima un sistema di design riutilizzabile; poi deck investitori, prototipi SaaS, dashboard, report e landing page ereditano lo stesso gusto.',
  'onboarding.buildBenefitMemoryTitle': 'Livello di gusto riutilizzabile',
  'onboarding.buildBenefitMemoryBody': 'Colori, tipografia, spaziature, componenti, voce e riferimenti diventano regole riutilizzabili dagli agent.',
  'onboarding.buildBenefitAlignedTitle': 'Il lavoro pagato resta coerente',
  'onboarding.buildBenefitAlignedBody': 'Pitch deck, proposte commerciali, schermate CRM, dashboard, PDF e pagine marketing seguono lo stesso standard.',
  'onboarding.buildBenefitSourcesTitle': 'Parti da prove esistenti',
  'onboarding.buildBenefitSourcesBody': 'Usa sito, repo, DESIGN.md, screenshot, font, Figma o un artefatto già consegnato a clienti.',
  'onboarding.buildPreviewLabel': 'Sistema pronto per il pagato',
  'onboarding.buildStart': 'Costruisci prima il sistema di design',
  'onboarding.buildHome': 'Esplora template per uso a pagamento',
