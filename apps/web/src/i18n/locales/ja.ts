...
export const ja: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 資金調達 / 投資家向け資料',
  'settings.onboardingUseSales': '🤝 営業提案 / クライアント向けピッチ',
  'settings.onboardingUseConsulting': '📑 コンサルティング成果物',
  ...
  'homeHero.title': 'どの高価値な成果物を出荷しますか？',
  'homeHero.startWithTemplate': 'まず成果物を選ぶ',
  ...
  'homeHero.subtitlePrefix': '有料ユース向けテンプレートを選び、ファイル、ブランド、agent で磨き込みます。',
  'homeHero.placeholder': '必要なビジネス成果物を説明してください…',
  'homeHero.placeholderActive': 'この有料ユース brief を編集するか、自分で書いてください…',
  ...
  'onboarding.buildTitle': 'すべての有料成果物に意図を感じさせる',
  'onboarding.buildBody': 'より良い出力への最短ルートは、まず再利用可能なデザインシステムを作ることです。その後、投資家デック、SaaS プロトタイプ、ダッシュボード、レポート、ランディングページが同じ美意識を継承します。',
  'onboarding.buildBenefitMemoryTitle': '再利用可能な美意識レイヤー',
  'onboarding.buildBenefitMemoryBody': '色、書体、余白、コンポーネント、声、参考例が、agent が再利用できるルールになります。',
  'onboarding.buildBenefitAlignedTitle': '有料の仕事が一貫する',
  'onboarding.buildBenefitAlignedBody': 'ピッチデック、営業提案、CRM 画面、ダッシュボード、PDF、マーケティングページが同じ基準に従います。',
  'onboarding.buildBenefitSourcesTitle': '既存の証拠から始める',
  'onboarding.buildBenefitSourcesBody': 'Web サイト、repo、DESIGN.md、スクリーンショット、フォント、Figma、または既に納品済みの顧客向け成果物を使えます。',
  'onboarding.buildPreviewLabel': '有料対応システム',
  'onboarding.buildStart': 'まずデザインシステムを作る',
  'onboarding.buildHome': '有料ユーステンプレートを探す',
