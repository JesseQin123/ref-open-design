...
export const th: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 ระดมทุน / เอกสารนักลงทุน',
  'settings.onboardingUseSales': '🤝 ข้อเสนอขาย / พิตช์ลูกค้า',
  'settings.onboardingUseConsulting': '📑 งานส่งมอบที่ปรึกษา',
  ...
  'homeHero.title': 'คุณต้องส่งมอบงานมูลค่าสูงอะไร?',
  'homeHero.startWithTemplate': 'เลือกงานส่งมอบก่อน',
  ...
  'homeHero.subtitlePrefix': 'เลือก template สำหรับงานที่ยอมจ่าย แล้วปรับด้วยไฟล์ แบรนด์ และ agent ของคุณ',
  'homeHero.placeholder': 'อธิบาย business deliverable ที่คุณต้องการ…',
  'homeHero.placeholderActive': 'แก้ brief งานที่ยอมจ่ายนี้ หรือเขียนของคุณเอง…',
  ...
  'onboarding.buildBody': 'ทางที่เร็วที่สุดสู่ output ที่ดีขึ้นคือเริ่มจาก design system ที่ใช้ซ้ำได้ จากนั้น investor deck, SaaS prototype, dashboard, report และ landing page จะรับ taste เดียวกันไปใช้',
  'onboarding.buildBenefitMemoryTitle': 'ชั้น taste ที่ใช้ซ้ำได้',
  'onboarding.buildBenefitMemoryBody': 'สี typography, spacing, component, voice และ reference จะกลายเป็นกฎที่ agent ใช้ซ้ำได้',
  'onboarding.buildBenefitAlignedTitle': 'งานที่ยอมจ่ายยังคงสม่ำเสมอ',
  'onboarding.buildBenefitAlignedBody': 'Pitch deck, sales proposal, CRM screen, dashboard, PDF และ marketing page ใช้มาตรฐานเดียวกัน',
  'onboarding.buildBenefitSourcesTitle': 'เริ่มจาก proof ที่มีอยู่',
  'onboarding.buildBenefitSourcesBody': 'ใช้ website, repo, DESIGN.md, screenshot, font, Figma หรือ artifact ที่เคยส่งลูกค้าแล้ว',
  'onboarding.buildPreviewLabel': 'ระบบพร้อมงาน paid',
  'onboarding.buildStart': 'สร้าง design system ก่อน',
  'onboarding.buildHome': 'สำรวจ template สำหรับงานที่ยอมจ่าย',
