...
export const id: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 Penggalangan dana / materi investor',
  'settings.onboardingUseSales': '🤝 Proposal penjualan / pitch klien',
  'settings.onboardingUseConsulting': '📑 Deliverable konsultasi',
  ...
  'homeHero.title': 'Deliverable bernilai tinggi apa yang perlu Anda kirim?',
  'homeHero.startWithTemplate': 'Pilih deliverable terlebih dahulu',
  ...
  'homeHero.subtitlePrefix': 'Pilih template pekerjaan berbayar, lalu sempurnakan dengan file, brand, dan agent Anda.',
  'homeHero.placeholder': 'Jelaskan deliverable bisnis yang Anda butuhkan…',
  'homeHero.placeholderActive': 'Edit brief pekerjaan berbayar ini atau tulis sendiri…',
  ...
  'onboarding.buildTitle': 'Buat setiap deliverable berbayar terasa terarah',
  'onboarding.buildBody': 'Jalur tercepat menuju output yang lebih baik adalah sistem desain reusable terlebih dahulu, lalu deck investor, prototipe SaaS, dashboard, laporan, dan landing page mewarisi standar rasa yang sama.',
  'onboarding.buildBenefitMemoryTitle': 'Lapisan taste yang reusable',
  'onboarding.buildBenefitMemoryBody': 'Warna, tipografi, spacing, komponen, voice, dan referensi menjadi aturan yang dapat digunakan ulang oleh agent Anda.',
  'onboarding.buildBenefitAlignedTitle': 'Pekerjaan berbayar tetap konsisten',
  'onboarding.buildBenefitAlignedBody': 'Pitch deck, proposal sales, layar CRM, dashboard, PDF, dan halaman marketing memakai standar yang sama.',
  'onboarding.buildBenefitSourcesTitle': 'Mulai dari bukti yang sudah ada',
  'onboarding.buildBenefitSourcesBody': 'Gunakan website, repo, DESIGN.md, screenshot, font, Figma, atau artefak yang sudah pernah dikirim ke pelanggan.',
  'onboarding.buildPreviewLabel': 'Sistem siap dibayar',
  'onboarding.buildStart': 'Bangun sistem desain terlebih dahulu',
  'onboarding.buildHome': 'Jelajahi template pekerjaan berbayar',
