...
export const ko: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 투자 유치 / 투자자 자료',
  'settings.onboardingUseSales': '🤝 세일즈 제안서 / 고객 피치',
  'settings.onboardingUseConsulting': '📑 컨설팅 산출물',
  ...
  'homeHero.title': '어떤 고가치 산출물을 내보내야 하나요?',
  'homeHero.startWithTemplate': '먼저 산출물을 선택하세요',
  ...
  'homeHero.subtitlePrefix': '유료 사용 템플릿을 고른 뒤 파일, 브랜드, agent로 다듬으세요.',
  'homeHero.placeholder': '필요한 비즈니스 산출물을 설명하세요…',
  'homeHero.placeholderActive': '이 유료 사용 brief를 편집하거나 직접 작성하세요…',
  ...
  'onboarding.buildTitle': '모든 유료 산출물이 의도적으로 보이게 하세요',
  'onboarding.buildBody': '더 나은 output의 가장 빠른 길은 먼저 재사용 가능한 디자인 시스템을 만드는 것입니다. 이후 투자자 deck, SaaS 프로토타입, 대시보드, 보고서, 랜딩 페이지가 같은 취향을 이어받습니다.',
  'onboarding.buildBenefitMemoryTitle': '재사용 가능한 taste layer',
  'onboarding.buildBenefitMemoryBody': '색상, 타이포그래피, spacing, component, voice, reference가 agent가 재사용할 수 있는 규칙이 됩니다.',
  'onboarding.buildBenefitAlignedTitle': '유료 작업이 일관되게 유지됩니다',
  'onboarding.buildBenefitAlignedBody': 'Pitch deck, sales proposal, CRM screen, dashboard, PDF, marketing page가 같은 기준을 따릅니다.',
  'onboarding.buildBenefitSourcesTitle': '기존 proof에서 시작하세요',
  'onboarding.buildBenefitSourcesBody': '웹사이트, repo, DESIGN.md, screenshot, font, Figma 또는 이미 고객에게 납품한 artifact를 사용하세요.',
  'onboarding.buildPreviewLabel': 'Reusable system',
  'onboarding.buildStart': '먼저 디자인 시스템 만들기',
  'onboarding.buildHome': '유료 사용 템플릿 탐색',
