...
export const zhTW: Dict = {
  ...
  'chat.example1Title': '募資路演 PPT',
  'chat.example1Tag': 'PPT',
  'chat.example1Prompt': '為一家正在募種子輪的設計工作室製作 10 頁投資人路演 PPT。包含封面、問題、洞察、產品、市場、成長數據、商業模式、團隊、募資需求和聯絡方式。要有編輯感，但敘事清晰、圖表克制，適合真實路演。',
  'chat.example2Title': '筆記 App 落地頁',
  'chat.example2Tag': '落地頁',
  'chat.example2Prompt': '為一款 AI 筆記 App 設計落地頁，核心能力是記錄會議、搜尋重點、把筆記轉成待辦。包含首屏、產品預覽、功能敘事、用戶證明、價格、FAQ 和行動按鈕。整體是安靜高效的生產力工具氣質，轉換路徑清楚。',
  'chat.example3Title': '冥想 App 行動原型',
  'chat.example3Tag': '行動',
  'chat.example3Prompt': '為一款冥想 App 製作四個行動端原型頁面：首頁、冥想播放頁、進度與連續打卡、睡眠內容合集。補上首次使用引導、底部導航、可存取控制和輕柔動效說明，讓流程能直接用於用戶測試。',
