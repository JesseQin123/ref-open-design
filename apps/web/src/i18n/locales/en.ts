...
export const en: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 Fundraising / investor materials',
  'settings.onboardingUseSales': '🤝 Sales proposal / client pitch',
  'settings.onboardingUseConsulting': '📑 Consulting deliverable',
  ...
  'homeHero.title': 'What do you need to ship?',
  'homeHero.startWithTemplate': 'Choose the deliverable first',
  ...
  'homeHero.subtitlePrefix': 'Pick a template, then refine it with your files, brand, and agent.',
  'homeHero.placeholder': 'Describe the deliverable you need…',
  'homeHero.placeholderActive': 'Edit this starter brief or write your own…',
  'homeHero.carousel.hint': 'Attach a file, link your design system, or describe what you want to make',
  'homeHero.carousel.onePageBrief': 'Draft a client-ready project brief',
  'homeHero.carousel.notesToDeck': 'Turn my notes into an investor deck',
  'homeHero.carousel.signupFlow': 'Prototype a SaaS onboarding flow',
  ...
  'homeHero.carousel.ordersDashboard': 'Build an executive KPI dashboard',
  'homeHero.carousel.productDetail': 'Lay out a pricing and product page',
  'homeHero.carousel.caseStudy': 'Outline a client-ready case study',
  'homeHero.carousel.landingIntro': 'Design a premium landing page',
  'homeHero.carousel.pitchDeck': 'Make an investor pitch deck',
  ...
  'onboarding.buildTitle': 'Make every deliverable look intentional',
  'onboarding.buildBody': 'The fastest path to better outputs is a reusable design system first, then investor decks, SaaS prototypes, dashboards, reports, and landing pages inherit the same taste.',
  'onboarding.buildBenefitMemoryTitle': 'Reusable taste layer',
  'onboarding.buildBenefitMemoryBody': 'Colors, type, spacing, components, voice, and example references become rules your agents can reuse.',
  'onboarding.buildBenefitAlignedTitle': 'Client work stays consistent',
  'onboarding.buildBenefitAlignedBody': 'Pitch decks, sales proposals, CRM screens, dashboards, PDFs, and marketing pages pull from the same standard.',
  'onboarding.buildBenefitSourcesTitle': 'Start from existing proof',
  'onboarding.buildBenefitSourcesBody': 'Use a website, repo, DESIGN.md, screenshots, fonts, Figma, or a finished customer-facing artifact.',
  'onboarding.buildPreviewLabel': 'Reusable system',
  'onboarding.buildStart': 'Build the design system first',
  'onboarding.buildHome': 'Explore templates',
