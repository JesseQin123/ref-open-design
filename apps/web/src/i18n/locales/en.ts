...
export const en: Dict = {
  ...
  'settings.privacyConsentFooter': 'Sharing this data helps us find crashes, slow requests, and common failures faster. You can change these any time in Settings → Privacy.',
