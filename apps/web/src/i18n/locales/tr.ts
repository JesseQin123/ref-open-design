...
export const tr: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 Fon toplama / yatırımcı materyalleri',
  'settings.onboardingUseSales': '🤝 Satış teklifi / müşteri sunumu',
  'settings.onboardingUseConsulting': '📑 Danışmanlık çıktısı',
  ...
  'homeHero.title': 'Hangi çıktıyı teslim etmeniz gerekiyor?',
  'homeHero.startWithTemplate': 'Önce çıktıyı seçin',
  ...
  'homeHero.subtitlePrefix': 'Bir şablon seçin, sonra dosyalarınız, markanız ve agent ile rafine edin.',
  'homeHero.placeholder': 'İhtiyacınız olan business deliverable’ı açıklayın…',
  'homeHero.placeholderActive': 'Bu başlangıç brief’ini düzenleyin veya kendiniz yazın…',
  ...
  'onboarding.buildTitle': 'Her çıktının bilinçli tasarlanmış görünmesini sağlayın',
  'onboarding.buildBody': 'Daha iyi output için en hızlı yol önce yeniden kullanılabilir bir design system kurmaktır. Sonra investor deckler, SaaS prototipleri, dashboardlar, raporlar ve landing page’ler aynı zevki miras alır.',
  'onboarding.buildBenefitMemoryTitle': 'Yeniden kullanılabilir zevk katmanı',
  'onboarding.buildBenefitMemoryBody': 'Renkler, tipografi, spacing, component’ler, voice ve reference’lar agent’larınızın yeniden kullanabileceği kurallara dönüşür.',
  'onboarding.buildBenefitAlignedTitle': 'Müşteri işleri tutarlı kalır',
  'onboarding.buildBenefitAlignedBody': 'Pitch deckler, satış teklifleri, CRM ekranları, dashboardlar, PDF’ler ve marketing sayfaları aynı standardı kullanır.',
  'onboarding.buildBenefitSourcesTitle': 'Mevcut kanıttan başlayın',
  'onboarding.buildBenefitSourcesBody': 'Website, repo, DESIGN.md, screenshot, font, Figma veya daha önce müşteriye teslim edilmiş bir artifact kullanın.',
  'onboarding.buildPreviewLabel': 'Reusable system',
  'onboarding.buildStart': 'Önce design system’i kur',
  'onboarding.buildHome': 'Şablonları keşfet',
